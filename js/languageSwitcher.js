...
const translations = {
  en: {
	...
	// index//
	"solar_system_description1":"Our solar system has eight planets, and five dwarf planets - all located in an outer spiral arm of the Milky Way galaxy called the Orion Arm, or Orion Spur. It can be divided into three regions: the inner solar system, the outer solar system, the Kuiper Belt, and the Oort Cloud.",
	...
	//ABOUT US//
	"bio_1": "Hello! My name is Viktor and I am the co-founder of the website. I am a student at PGI \"Ivan Iliev\", where I study \"Economic Informatics\". The motives for choosing this theme are precisely the interest we both share towards space, and our desire to intrigue more people by acquainting them with its mysteries.",
	"bio_2": "Greetings! My name is Deyan and I am the other co-founder of this website. I am a student at Language High School \"Acad. Lyudmil Stoyanov\", where I study French and English languages. After the 10th grade, I have the opportunity to specialize in \"information technologies\".",
	...
	//MERCURY
	"mercury1": "The planet Mercury is named after Mercury, the messenger of the Roman gods, due to its rapid orbit around the Sun - 88 days. One Mercurian day - the time it takes for one complete rotation around its own axis - lasts 59 Earth days",
	...
	"mercury5":"Mercury has been studied by several spacecraft, including \"Mariner 10\" and \"MESSENGER\". These missions have provided valuable data about the planet, including evidence of the presence of water in ice form, despite the high temperatures.",
	...
	//EARTH//
	"earth1":"The Earth's surface is covered by water by about 71%, making it the only planet in the Solar System with liquid water on its surface. The majority of this water is found in the oceans, which account for about 97% of the planet's water. Freshwater represents about 3% of the total amount of water on Earth, and of these 3%, about 69% are in the form of ice in glaciers and polar ice caps.",
  ...
  bg: {
	...
	"venus_video":"https://www.youtube.com/embed/m31FeYAnxrU?si=17b9efgreoDxOd0R",
	...
	//ABOUT US//
	"bio_1": "Здравейте! Името ми е Виктор и съм съосновател на този сайт. Ученик съм в ПГИ „Иван Илиев“, където изучавам „Икономическа информатика“. Мотивите за избирането на темата са именно интересът, който и двамата споделяме към космоса, и желанието ни да заинтригуваме повече хора, запознавайки ги с мистериите му.",
	"bio_2": "Привет! Казвам се Деян и съм другият съосновател на сайта. Ученик съм в ЕГ „Акад. Людмил Стоянов“, където изучавам френски и английски език. От 10-ти клас имам възможността да специализирам в профил „Информационни технологии“.",
	"Viktor_name": "Виктор Ангелов",
	"Deyan_name": "Деян Петелов",
	"contact_us": "Свържете се с нас!",
	"any_questions":"С радост ше отговорим на въпросите ви.",
